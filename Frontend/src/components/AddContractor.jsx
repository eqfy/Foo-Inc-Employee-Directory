...
function AddContractor(props) {
    ...
    const validateFormField = (event) => {
        ...
        let fieldsStatusIsValid = state.fieldsStatusIsValid;
    ...
    const handleTerminateDateChange = (selectedTerminateDate) => {
        let fieldsStatusIsValid = state.fieldsStatusIsValid;
        let errors = state.errors;
        fieldsStatusIsValid['terminationDate'] = !(state.selectedTerminateDate < state.selectedHireDate);
    ...
    // TODO: 4. Fix email, contract end date validation
...
function fieldErrorHelper(fieldName){
    return state.fieldsStatusIsValid[fieldName] === undefined? 
    false:
    !state.fieldsStatusIsValid[fieldName];
}

function fieldHelperText(fieldName){
    return !state.fieldsStatusIsValid[fieldName]? state.errors[fieldName]: '';
}
                ...
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                    ...
                    <Grid item xs={6}>
                        <Grid container justify="space-around">
                            ...
                            value={state.selectedTerminateDate}
